				...
				options: [
					{
						...
						routing: {
							request: {
								method: 'GET',
								url: '?module=contract&action=getabi&address=0xBB9bc244D798123fDe783fCc1C72d3Bb8C189413&apikey={{$credentials.api_key}}',
							},
						},
					},
				],
				...
				options: [
					{
						...
						routing: {
							request: {
								method: 'GET',
								url: '?module=contract&action=getsourcecode&address=0xBB9bc244D798123fDe783fCc1C72d3Bb8C189413&apikey={{$credentials.api_key}}',
							},
						},
					},
				],
